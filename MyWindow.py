...
class m_MainWindow(QMainWindow):
	def __init__(self):
		...
		self.tracker=Tracker('/home/visitor16/czy/pysot/experiments/siamrpn_r50_l234_dwxcorr/config.yaml','/home/visitor16/czy/pysot/experiments/siamrpn_r50_l234_dwxcorr/model.pth')
		self.slotInit()
